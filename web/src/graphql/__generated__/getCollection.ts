...
export interface getCollection_collection_entries_item_link_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_link_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_link_item_labels[];
}
...
export interface getCollection_collection_entries_item_link {
  ...
  title: string | null;
  description: string | null;
  item: getCollection_collection_entries_item_link_item | null;
}

export interface getCollection_collection_entries_item_file_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_file_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_file_item_labels[];
}
...
export interface getCollection_collection_entries_item_file {
  ...
  createdAt: any;
  updatedAt: any;
  item: getCollection_collection_entries_item_file_item;
}

export interface getCollection_collection_entries_item_note_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_note_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_note_item_labels[];
}
...
export interface getCollection_collection_entries_item_note {
  ...
  createdAt: any;
  updatedAt: any;
  item: getCollection_collection_entries_item_note_item | null;
}
...
export interface getCollection_collection_entries_item_items_link_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_items_link_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_items_link_item_labels[];
}
...
export interface getCollection_collection_entries_item_items_link {
  ...
  title: string | null;
  description: string | null;
  item: getCollection_collection_entries_item_items_link_item | null;
}

export interface getCollection_collection_entries_item_items_file_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_items_file_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_items_file_item_labels[];
}
...
export interface getCollection_collection_entries_item_items_file {
  ...
  createdAt: any;
  updatedAt: any;
  item: getCollection_collection_entries_item_items_file_item;
}

export interface getCollection_collection_entries_item_items_note_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_items_note_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_items_note_item_labels[];
}
...
export interface getCollection_collection_entries_item_items_note {
  ...
  createdAt: any;
  updatedAt: any;
  item: getCollection_collection_entries_item_items_note_item | null;
}

export interface getCollection_collection_entries_item_items_googleContact_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_items_googleContact_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_items_googleContact_item_labels[];
}
...
export interface getCollection_collection_entries_item_items_googleContact {
  ...
  item: getCollection_collection_entries_item_items_googleContact_item;
}
...
export interface getCollection_collection_entries_item_googleContact_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface getCollection_collection_entries_item_googleContact_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: getCollection_collection_entries_item_googleContact_item_labels[];
}
...
export interface getCollection_collection_entries_item_googleContact {
  ...
  companyTitle: string | null;
  companyName: string | null;
  item: getCollection_collection_entries_item_googleContact_item;
}
