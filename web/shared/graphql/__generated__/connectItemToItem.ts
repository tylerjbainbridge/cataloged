...
export interface connectItemToItem_connectItemToItem_items_link_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface connectItemToItem_connectItemToItem_items_link_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: connectItemToItem_connectItemToItem_items_link_item_labels[];
}
...
export interface connectItemToItem_connectItemToItem_items_link {
  ...
  title: string | null;
  description: string | null;
  item: connectItemToItem_connectItemToItem_items_link_item | null;
}

export interface connectItemToItem_connectItemToItem_items_file_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface connectItemToItem_connectItemToItem_items_file_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: connectItemToItem_connectItemToItem_items_file_item_labels[];
}
...
export interface connectItemToItem_connectItemToItem_items_file {
  ...
  createdAt: any;
  updatedAt: any;
  item: connectItemToItem_connectItemToItem_items_file_item;
}

export interface connectItemToItem_connectItemToItem_items_note_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface connectItemToItem_connectItemToItem_items_note_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: connectItemToItem_connectItemToItem_items_note_item_labels[];
}
...
export interface connectItemToItem_connectItemToItem_items_note {
  ...
  createdAt: any;
  updatedAt: any;
  item: connectItemToItem_connectItemToItem_items_note_item | null;
}

export interface connectItemToItem_connectItemToItem_items_googleContact_item_labels {
  __typename: "Label";
  id: string;
  name: string;
}

export interface connectItemToItem_connectItemToItem_items_googleContact_item {
  __typename: "Item";
  id: string;
  type: string;
  date: any;
  createdAt: any;
  updatedAt: any;
  labels: connectItemToItem_connectItemToItem_items_googleContact_item_labels[];
}
...
export interface connectItemToItem_connectItemToItem_items_googleContact {
  ...
  item: connectItemToItem_connectItemToItem_items_googleContact_item;
}
