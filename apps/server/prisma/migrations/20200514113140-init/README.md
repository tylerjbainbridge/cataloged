# Migration `20200514113140-init`

This migration has been generated by Tyler Bainbridge at 5/14/2020, 11:31:40 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."File" DROP COLUMN "metadata",
ADD COLUMN "metadata" text   ;

CREATE UNIQUE INDEX "GoogleDriveWebhook_googleAccountId" ON "public"."GoogleDriveWebhook"("googleAccountId")

ALTER TABLE "public"."GoogleDriveWebhook" ADD FOREIGN KEY ("googleAccountId")REFERENCES "public"."GoogleAccount"("id") ON DELETE CASCADE  ON UPDATE CASCADE
```
