# Migration `20200509154954-init`

This migration has been generated by Tyler Bainbridge at 5/9/2020, 3:49:54 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
DROP INDEX "public"."File.name_title_description_extension_isUploaded_isFailed_exter"

ALTER TABLE "public"."File" DROP CONSTRAINT IF EXiSTS "File_googleAccountId_fkey",
