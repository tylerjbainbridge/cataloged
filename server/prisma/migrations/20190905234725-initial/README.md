# Migration `20190905234725-initial`

This migration has been generated by Tyler Bainbridge at 9/5/2019, 11:47:25 PM.
...
CREATE TABLE "public"."Link"("id" text NOT NULL  ,"createdAt" timestamp(3) NOT NULL  ,"updatedAt" timestamp(3) NOT NULL DEFAULT '1970-01-01 00:00:00' ,"href" text NOT NULL DEFAULT '' ,"title" text   ,"description" text   ,"image" text   ,"favicon" text   ,"notes" text NOT NULL DEFAULT '' ,PRIMARY KEY ("id"))
;
...
You can use a specific Photon built for this migration (20190905234725-initial)
