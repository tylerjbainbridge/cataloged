# Migration `20191111180058-init`

This migration has been generated by Tyler Bainbridge at 11/11/2019, 6:00:58 PM.
...
You can use a specific Photon built for this migration (20191111180058-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191111180058-init'
